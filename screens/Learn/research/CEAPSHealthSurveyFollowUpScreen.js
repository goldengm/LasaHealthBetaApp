                    ...
                    <View
                      ...
                      <View
                        ...
                        <Text
                          ...
                          {/* NPS Survey, HRQoL Survey, and EHP-30 Survey login goes
                          here, need to make all these survey's functional */}
                        ...
                        <Text
                          ...
                          ENDOMETRIOSIS, HAVE YOU...
                        </Text>

                        {utils.ehp30Questions.map((item, index) => (
                          <View key={index}>
                            <Text
                              style={{
                                color: theme.COLORS.TEXT1,
                            ...
                            <View
                              ...
                              <Select
                                customPrompt="Select an option"
                                defaultIndex={1}
                                options={utils.ehp30QualityList}
                                customButtonStyle={{
                                  height: theme.SIZES.BASE * 3,
                                  borderRadius: theme.SIZES.BASE,
                                  shadowRadius: 0,
                          ...
                          <Button
                            ...
                            onPress={() => {
                              if (
                                ...
                                // this.state.q4Answer !== '' &&
                                // this.state.q5Answer !== ''
                                Object.values(this.state).every(i => i !== '')
                              ) {
                                    ...
                                    if (
                                      Object.keys(
                                        this.props.userProfile
                                          .introHealthSurvey[this.setupBeginTS],
                                      ).includes('HRQOL' + i)
                                    ) {
                                      newHealthSurveyObj['HRQOL' + i] =
                                        this.props.userProfile.introHealthSurvey[
                                          this.setupBeginTS
                                        ]['HRQOL' + i];
                                    }
