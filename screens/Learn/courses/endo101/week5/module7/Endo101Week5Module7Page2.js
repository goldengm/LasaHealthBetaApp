...
import {updateEndo101Week5Module7Q2Action} from '../../../../../../redux/actions/learnActions';
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        True / False. Excision is when the tissue is burned off
                        during laparoscopy
                      </Text>
                    </View>
                    <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week5Module7Q2Action('True'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week5Module7Q2Action('False'),
                              );
                            }
                      ...
                      {this.state.correctAnswer && (
                        <View
                          ...
                          <Text
                            ...
                            Correct! This is the definition of ablation.
                          </Text>
                        </View>
                      )}
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              navigation.navigate('Endo101Week5Module7Page3');
                            }
                          }}></Button>
                      </View>
                    </View>
