...
class Endo101Week5Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week5.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week5.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn about the value of laparoscopic surgery, how to decide
                    the right time to have one and what to expect.
                  </Text>
                </View>
                <RoundedTopContainer
                  style={{
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week5.weekProgress /
                        this.props.endoCourse.week5.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week5Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week5.weekProgress >= 1) {
                          navigation.navigate('Endo101Week5Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week5.weekProgress >= 2) {
                          navigation.navigate('Endo101Week5Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week5.weekProgress >= 3) {
                          navigation.navigate('Endo101Week5Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week5.weekProgress >= 4) {
                          navigation.navigate('Endo101Week5Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week5.weekProgress >= 5) {
                          navigation.navigate('Endo101Week5Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week5.weekProgress >= 6) {
                          navigation.navigate('Endo101Week5Module7Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week5CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week5.weekProgress <= 0) {
                            navigation.navigate('Endo101Week5Module1Page1');
                          } else if (
                            this.props.endoCourse.week5.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week5Module2Page1');
                          } else if (
                            this.props.endoCourse.week5.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week5Module3Page1');
                          } else if (
                            this.props.endoCourse.week5.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week5Module4Page1');
                          } else if (
                            this.props.endoCourse.week5.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week5Module5Page1');
                          } else if (
                            this.props.endoCourse.week5.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week5Module6Page1');
                          } else if (
                            this.props.endoCourse.week5.weekProgress == 6
                          ) {
                            navigation.navigate('Endo101Week5Module7Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week5Screen);
