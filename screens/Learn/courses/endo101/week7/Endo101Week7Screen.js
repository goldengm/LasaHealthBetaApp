...
class Endo101Week7Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week7.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week7.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Physical Therapy, Pain Management Strategies, and Physical
                    Activity
                  </Text>
                  ...
                  <Text
                    ...
                    Learn about pelvic floor therapy and at-home exercises to
                    reduce your pain.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week7.weekProgress /
                        this.props.endoCourse.week7.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week7Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week7.weekProgress >= 1) {
                          navigation.navigate('Endo101Week7Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week7.weekProgress >= 2) {
                          navigation.navigate('Endo101Week7Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week7.weekProgress >= 3) {
                          navigation.navigate('Endo101Week7Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week7.weekProgress >= 4) {
                          navigation.navigate('Endo101Week7Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week7.weekProgress >= 5) {
                          navigation.navigate('Endo101Week7Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week7.weekProgress >= 6) {
                          navigation.navigate('Endo101Week7Module7Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week7CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week7.weekProgress <= 0) {
                            navigation.navigate('Endo101Week7Module1Page1');
                          } else if (
                            this.props.endoCourse.week7.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week7Module2Page1');
                          } else if (
                            this.props.endoCourse.week7.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week7Module3Page1');
                          } else if (
                            this.props.endoCourse.week7.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week7Module4Page1');
                          } else if (
                            this.props.endoCourse.week7.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week7Module5Page1');
                          } else if (
                            this.props.endoCourse.week7.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week7Module6Page1');
                          } else if (
                            this.props.endoCourse.week7.weekProgress == 6
                          ) {
                            navigation.navigate('Endo101Week7Module7Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week7Screen);
