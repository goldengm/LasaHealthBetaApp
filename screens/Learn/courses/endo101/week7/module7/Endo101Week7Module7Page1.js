...
import {updateEndo101Week7Module7Q1Action} from '../../../../../../redux/actions/learnActions';
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week7Module7Q1Action('Urination'),
                              );
                            }
                            this.setSelectedIndex(0);
                          }}
                          title={'Urination'}></Button>
                      </View>
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week7Module7Q1Action(
                                  'Bowel movements',
                                ),
                              );
                            }
                      ...
                      {this.state.correctAnswer && (
                        <View
                          ...
                          <Text
                            ...
                            Correct! All of the above. The pelvic floor plays a
                            role in urination, bowel movements, and sexual
                            function.
                          </Text>
                        </View>
                      )}
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              navigation.navigate('Endo101Week7Module7Page2');
                            }
                          }}></Button>
                      </View>
                    </View>
