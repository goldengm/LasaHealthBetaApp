...
import {
  updateEndo101Week7ProgressAction,
  updateEndo101Week7Module4Q1Action,
  updateEndo101Week7Module4Q3Action,
                      ...
                      {Object.keys(this.state.multiSelectedOptions).length >
                        ...
                        <View>
                          ...
                          <Text
                            ...
                            Would you like to share your experience using any of
                            the these tools with other women?{'\u000A'}
                          </Text>
                          ...
                          <View
                            ...
                            <Input
                              ...
                              onChangeText={value => {
                                ...
                                this.props.dispatch(
                                  updateEndo101Week7Module4Q3Action(value),
                                );
                              }}
                            />
                          </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            Promise.resolve()
                              ...
                              .then(() => {
                                return this.props.dispatch(
                                  updateEndo101Week7ProgressAction(4),
                                );
                              })
                              .then(() =>
