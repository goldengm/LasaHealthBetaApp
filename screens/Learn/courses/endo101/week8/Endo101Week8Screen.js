...
class Endo101Week8Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week8.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week8.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn about foods that might trigger endometriosis flare-ups
                    and foods that might improve symptoms.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week8.weekProgress /
                        this.props.endoCourse.week8.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week8Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week8.weekProgress >= 1) {
                          navigation.navigate('Endo101Week8Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                        uncheckedColor={theme.COLORS.BACKGROUND3}
                        title="Endometriosis and Nutrition"
                        checked={true}
                        containerStyle={{
                          marginVertical: 0,
                          left: -10,
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week8.weekProgress >= 2) {
                          navigation.navigate('Endo101Week8Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week8.weekProgress >= 3) {
                          navigation.navigate('Endo101Week8Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week8.weekProgress >= 4) {
                          navigation.navigate('Endo101Week8Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week8.weekProgress >= 5) {
                          navigation.navigate('Endo101Week8Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week8CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week8.weekProgress <= 0) {
                            navigation.navigate('Endo101Week8Module1Page1');
                          } else if (
                            this.props.endoCourse.week8.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week8Module2Page1');
                          } else if (
                            this.props.endoCourse.week8.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week8Module3Page1');
                          } else if (
                            this.props.endoCourse.week8.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week8Module4Page1');
                          } else if (
                            this.props.endoCourse.week8.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week8Module5Page1');
                          } else if (
                            this.props.endoCourse.week8.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week8Module6Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week8Screen);
