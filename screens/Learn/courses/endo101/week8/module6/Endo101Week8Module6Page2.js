...
import {updateEndo101Week8Module7Q2Action} from '../../../../../../redux/actions/learnActions';
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week8Module7Q2Action('Fiber'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week8Module7Q2Action('Red meat'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week8Module7Q2Action('Alcohol'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week8Module7Q2Action('Gluten'),
                              );
                            }
