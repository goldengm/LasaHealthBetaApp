...
import {updateEndo101Week1Module6Q2Action} from '../../../../../../redux/actions/learnActions';
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week1Module6Q2Action(
                                  'Anyone newly diagnosed with endometriosis',
                                ),
                              );
                            }
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week1Module6Q2Action(
                                  'Anyone experiencing symptoms of endometriosis',
                                ),
                              );
                            }
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              navigation.navigate('Endo101Week1Module6Page3');
                            }
                          }}></Button>
                      </View>
                    </View>
