...
import {updateEndo101Week1Module6Q3Action} from '../../../../../../redux/actions/learnActions';
                    ...
                    <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week1Module6Q3Action(
                          ...
                          title={'Hysterectomy cures endometriosis'}></Button>
                      </View>
                      ...
                      <View
                        ...
                        <Button
                          ...
                          title={'Pregnancy cures endometriosis'}></Button>
                      </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week1Module6Q3Action(
                                  'Only women can get endometriosis',
                                ),
                              );
                            }
                            this.setSelectedIndex(2);
                          }}
                          title={'Only women can get endometriosis'}></Button>
                      </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week1Module6Q3Action(
                                  'Endometriosis is sometimes shortened to “Endo”',
                                ),
                              );
                            }
                      ...
                      {this.state.correctAnswer && (
                        <View
                          ...
                          <Text
                            ...
                            Correct! Endo is a common shorthand for
                            endometriosis.
                          </Text>
                        </View>
                      )}
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              navigation.navigate('Endo101Week1Module6Page4');
                            }
                          }}></Button>
                      </View>
                    </View>
