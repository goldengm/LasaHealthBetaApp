                  ...
                  <View
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week1.weekProgress <= 0) {
                            navigation.navigate('Endo101Week1Module1Page1');
                          } else if (
                            this.props.endoCourse.week1.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week1Module2Page1');
                          } else if (
                            this.props.endoCourse.week1.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week1Module3Page1');
                          } else if (
                            this.props.endoCourse.week1.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week1Module4Page1');
                          } else if (
                            this.props.endoCourse.week1.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week1Module5Page1');
                          } else if (
                            this.props.endoCourse.week1.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week1Module6Page1');
                          } else {
