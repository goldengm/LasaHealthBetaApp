...
import {updateEndo101Week2Module1Q3Action} from '../../../../../../redux/actions/learnActions';
...
class LearnCoursePlaceholderScreen extends React.Component {
  ...
  allAnswersFilledIn = () => {
    ...
    return (
      ...
      !(this.state.singleSelectedOption4 == -1) &&
      !(this.state.singleSelectedOption5 == -1) &&
      !(this.state.singleSelectedOption6 == -1)
    );
  };
                    ...
                    <View
                      ...
                      <View
                        ...
                        <Button
                          ...
                          title="Next"
                          onPress={() => {
                            if (this.allAnswersFilledIn()) {
                              this.props.dispatch(
                                updateEndo101Week2Module1Q3Action({
                              ...
                              navigation.navigate('Endo101Week2Module1Page5');
                            }
                          }}></Button>
                      </View>
                    </View>
