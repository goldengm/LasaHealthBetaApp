...
import {updateEndo101Week2Module6Q4Action} from '../../../../../../redux/actions/learnActions';
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week2Module6Q4Action(
                                  'Menstruation',
                                ),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week2Module6Q4Action('Ovulation'),
                              );
                            }
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              Promise.resolve()
                                ...
                                //     updateEndo101Week2ProgressAction(6)
                                //   );
                                // })
                                // .then(() => {
                                //   return this.props.dispatch(
                                //     updateEndo101ProgressAction(2)
                                //   );
                                // })
                                .then(() =>
                                  navigation.navigate(
                                    'Endo101Week2Module6Page5',
                                  ),
                                );
                            }
                          }}></Button>
