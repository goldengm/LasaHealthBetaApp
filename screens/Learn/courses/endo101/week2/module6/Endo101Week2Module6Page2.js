...
import {updateEndo101Week2Module6Q2Action} from '../../../../../../redux/actions/learnActions';
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        Which part of the body produces hormones like estrogen
                        and progesterone?
                      </Text>
                    </View>
                    <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week2Module6Q2Action('Uterus'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week2Module6Q2Action('Ovaries'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week2Module6Q2Action(
                                  'Fallopian Tubes',
                                ),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week2Module6Q2Action('Vagina'),
                              );
                            }
                      ...
                      {this.state.correctAnswer && (
                        <View
                          ...
                          <Text
                            ...
                            Correct! Ovaries, but estrogen can also be produced
                            by fat cells and adrenal glands.
                          </Text>
                        </View>
                      )}
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              navigation.navigate('Endo101Week2Module6Page3');
                            }
                          }}></Button>
                      </View>
                    </View>
