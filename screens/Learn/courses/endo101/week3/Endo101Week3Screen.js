...
class Endo101Week3Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week3.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week3.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week3.weekProgress /
                        this.props.endoCourse.week3.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week3Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week3.weekProgress >= 1) {
                          navigation.navigate('Endo101Week3Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week3.weekProgress >= 2) {
                          navigation.navigate('Endo101Week3Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week3.weekProgress >= 3) {
                          navigation.navigate('Endo101Week3Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week3.weekProgress >= 4) {
                          navigation.navigate('Endo101Week3Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week3.weekProgress >= 5) {
                          navigation.navigate('Endo101Week3Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week3.weekProgress >= 6) {
                          navigation.navigate('Endo101Week3Module7Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week3CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week3.weekProgress <= 0) {
                            navigation.navigate('Endo101Week3Module1Page1');
                          } else if (
                            this.props.endoCourse.week3.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week3Module2Page1');
                          } else if (
                            this.props.endoCourse.week3.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week3Module3Page1');
                          } else if (
                            this.props.endoCourse.week3.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week3Module4Page1');
                          } else if (
                            this.props.endoCourse.week3.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week3Module5Page1');
                          } else if (
                            this.props.endoCourse.week3.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week3Module6Page1');
                          } else if (
                            this.props.endoCourse.week3.weekProgress == 6
                          ) {
                            navigation.navigate('Endo101Week3Module7Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week3Screen);
