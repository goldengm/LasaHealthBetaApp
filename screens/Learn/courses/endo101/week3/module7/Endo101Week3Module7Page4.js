                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        Why should you track your symptoms?
                      </Text>
                    </View>
                    <View
                      style={{
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              // this.props.dispatch(
                              //   updateEndo101Week3Module7Q4Action(
                              //     "To understand symptom trends and changes"
                              //   )
                              // );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          title={'To improve your health'}></Button>
                      </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              // this.props.dispatch(
                              //   updateEndo101Week3Module7Q4Action(
                              //     "To contribute to endometriosis research"
                              //   )
                              // );
                            }
                      ...
                      {this.state.correctAnswer && (
                        <View
                          ...
                          <Text
                            ...
                            Correct! All of the above. There are many benefits
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              Promise.resolve()
                                ...
                                //     updateEndo101Week3ProgressAction(7)
                                //   );
                                // })
                                // .then(() => {
                                //   return this.props.dispatch(
                                //     updateEndo101ProgressAction(3)
                                //   );
                                // })
                                .then(() =>
                                  navigation.navigate(
                                    'Endo101Week3Module7Page5',
                                  ),
                                );
                            }
                          }}></Button>
