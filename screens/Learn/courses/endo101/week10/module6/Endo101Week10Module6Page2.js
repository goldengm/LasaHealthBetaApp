...
import {updateEndo101Week10Module6Q2Action} from '../../../../../../redux/actions/learnActions';
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        What is a common appreach for endometriosis lesions in
                        adolescent patients?
                      </Text>
                    </View>
                    <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week10Module6Q2Action('Blue'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week10Module6Q2Action('Black'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week10Module6Q2Action('Purple'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week10Module6Q2Action(
                                  'Clear or red',
                                ),
                              );
                            }
