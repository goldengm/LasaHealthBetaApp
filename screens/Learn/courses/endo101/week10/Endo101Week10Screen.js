...
class Endo101Week10Screen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week10.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week10.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
  ...
  render() {
    ...
    return (
      <ScreenTemplateWrapper
        headerPadding={true}
        width={width}
        customHeaderPaddingHeight={iosPlatform() ? 155 : 150}
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn about how endometriosis impacts different life stages
                    including puberty, fertility, pregnancy, and menopause.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week10.weekProgress /
                        this.props.endoCourse.week10.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week10Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week10.weekProgress >= 1) {
                          navigation.navigate('Endo101Week10Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week10.weekProgress >= 2) {
                          navigation.navigate('Endo101Week10Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week10.weekProgress >= 3) {
                          navigation.navigate('Endo101Week10Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week10.weekProgress >= 4) {
                          navigation.navigate('Endo101Week10Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week10.weekProgress >= 5) {
                          navigation.navigate('Endo101Week10Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week10CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week10.weekProgress <= 0) {
                            navigation.navigate('Endo101Week10Module1Page1');
                          } else if (
                            this.props.endoCourse.week10.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week10Module2Page1');
                          } else if (
                            this.props.endoCourse.week10.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week10Module3Page1');
                          } else if (
                            this.props.endoCourse.week10.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week10Module4Page1');
                          } else if (
                            this.props.endoCourse.week10.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week10Module5Page1');
                          } else if (
                            this.props.endoCourse.week10.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week10Module6Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week10Screen);
