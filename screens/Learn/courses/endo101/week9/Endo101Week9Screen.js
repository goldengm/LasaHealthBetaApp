...
class Endo101Week9Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week9.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week9.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn about alternative therapies that some patients found
                    have been helpful including acupuncture, traditional Chinese
                    medicine, and electrotherapy.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week9.weekProgress /
                        this.props.endoCourse.week9.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week9Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week9.weekProgress >= 1) {
                          navigation.navigate('Endo101Week9Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                        uncheckedColor={theme.COLORS.BACKGROUND3}
                        title="Researching Alternative Therapies"
                        checked={true}
                        containerStyle={{
                          marginVertical: 0,
                          left: -10,
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week9.weekProgress >= 2) {
                          navigation.navigate('Endo101Week9Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week9.weekProgress >= 3) {
                          navigation.navigate('Endo101Week9Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week9.weekProgress >= 4) {
                          navigation.navigate('Endo101Week9Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week9.weekProgress >= 5) {
                          navigation.navigate('Endo101Week9Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week9CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week9.weekProgress <= 0) {
                            navigation.navigate('Endo101Week9Module1Page1');
                          } else if (
                            this.props.endoCourse.week9.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week9Module2Page1');
                          } else if (
                            this.props.endoCourse.week9.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week9Module3Page1');
                          } else if (
                            this.props.endoCourse.week9.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week9Module4Page1');
                          } else if (
                            this.props.endoCourse.week9.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week9Module5Page1');
                          } else if (
                            this.props.endoCourse.week9.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week9Module6Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week9Screen);
