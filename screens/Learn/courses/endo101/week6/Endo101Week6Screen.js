...
class Endo101Week6Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week6.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week6.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn about medication options available and considerations
                    when choosing a medication strategy.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week6.weekProgress /
                        this.props.endoCourse.week6.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week6Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week6.weekProgress >= 1) {
                          navigation.navigate('Endo101Week6Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week6.weekProgress >= 2) {
                          navigation.navigate('Endo101Week6Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                        uncheckedColor={theme.COLORS.BACKGROUND3}
                        title="Secondary Hormonal Medication"
                        checked={true}
                        containerStyle={{
                          marginVertical: 0,
                          paddingVertical: 0,
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week6.weekProgress >= 3) {
                          navigation.navigate('Endo101Week6Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week6.weekProgress >= 4) {
                          navigation.navigate('Endo101Week6Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week6.weekProgress >= 5) {
                          navigation.navigate('Endo101Week6Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week6.weekProgress >= 6) {
                          navigation.navigate('Endo101Week6Module7Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week6CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week6.weekProgress <= 0) {
                            navigation.navigate('Endo101Week6Module1Page1');
                          } else if (
                            this.props.endoCourse.week6.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week6Module2Page1');
                          } else if (
                            this.props.endoCourse.week6.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week6Module3Page1');
                          } else if (
                            this.props.endoCourse.week6.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week6Module4Page1');
                          } else if (
                            this.props.endoCourse.week6.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week6Module5Page1');
                          } else if (
                            this.props.endoCourse.week6.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week6Module6Page1');
                          } else if (
                            this.props.endoCourse.week6.weekProgress == 6
                          ) {
                            navigation.navigate('Endo101Week6Module7Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week6Screen);
