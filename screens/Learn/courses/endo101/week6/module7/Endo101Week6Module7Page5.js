...
import {
  updateEndo101Week6Module7Q5Action,
  updateEndo101Week6Module7Q6Action,
  updateEndo101Week6Module7Q7Action,
                        ...
                        <View
                          ...
                          <Slider
                            ...
                            onSlidingComplete={sliderVal => {
                              ...
                              this.props.dispatch(
                                updateEndo101Week6Module7Q5Action(sliderVal),
                              );
                              // this.props.dispatch(
                        ...
                        <View
                          ...
                          <Slider
                            ...
                            onSlidingComplete={sliderVal => {
                              ...
                              this.props.dispatch(
                                updateEndo101Week6Module7Q6Action(sliderVal),
                              );
                            }}
                            thumbTintColor={theme.COLORS.PRIMARY2}
                            minimumTrackTintColor={theme.COLORS.PRIMARY2}
                        ...
                        <View
                          ...
                          <Slider
                            ...
                            onSlidingComplete={sliderVal => {
                              ...
                              this.props.dispatch(
                                updateEndo101Week6Module7Q7Action(sliderVal),
                              );
                            }}
                            thumbTintColor={theme.COLORS.PRIMARY2}
                            minimumTrackTintColor={theme.COLORS.PRIMARY2}
                          ...
                          <Button
                            ...
                            onPress={() => {
                              if (
                                ...
                                navigation.navigate('Endo101Week6Module7Page6');
                              }
                            }}></Button>
                        </View>
                      </View>
