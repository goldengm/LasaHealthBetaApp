...
import {
  updateEndo101Week6Module7Q8Action,
  updateEndo101Week6Module7Q9Action,
  updateEndo101Week6Module7Q10Action,
                    ...
                    <View
                      ...
                      <View
                        ...
                        <Text
                          ...
                          Goal Progress. On a scale of 1-5, how much progress
                          did you make this week in achieving these goals?
                        </Text>
                      </View>
                      <View
                        style={{
                        ...
                        <View
                          ...
                          <Slider
                            ...
                            onSlidingComplete={sliderVal => {
                              ...
                              this.props.dispatch(
                                updateEndo101Week6Module7Q8Action(sliderVal),
                              );
                            }}
                        ...
                        <View
                          ...
                          <Slider
                            ...
                            onSlidingComplete={sliderVal => {
                              ...
                              this.props.dispatch(
                                updateEndo101Week6Module7Q9Action(sliderVal),
                              );
                            }}
                            thumbTintColor={theme.COLORS.PRIMARY2}
                            minimumTrackTintColor={theme.COLORS.PRIMARY2}
                        ...
                        <View
                          ...
                          <Slider
                            ...
                            onSlidingComplete={sliderVal => {
                              ...
                              this.props.dispatch(
                                updateEndo101Week6Module7Q10Action(sliderVal),
                              );
                            }}
                            thumbTintColor={theme.COLORS.PRIMARY2}
                            minimumTrackTintColor={theme.COLORS.PRIMARY2}
                          ...
                          <Button
                            ...
                            onPress={() => {
                              if (
                                ...
                                navigation.navigate('Endo101Week6Module7Page7');
                              }
                            }}></Button>
                        </View>
                      </View>
