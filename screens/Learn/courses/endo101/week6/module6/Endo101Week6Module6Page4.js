...
import {
  updateEndo101Week6ProgressAction,
  updateEndo101Week6Module6Q2Action,
  updateEndo101Week6Module6Q4Action,
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      multiOptionPickerList: [
        [0, 'Combination hormonal birth control'],
        [1, 'Progestin-only hormonal birth control'],
        [2, 'IUD'],
        [3, 'Visanne / Dienogest'],
        [4, 'Depo-vera injection'],
        [5, 'Nexplanon subdermal implant'],
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        What medications have you tried to treat or manage
                        symptoms of endometriosis? (multiple choice, select all
                        that apply)
                      </Text>
                      ...
                      {Object.keys(this.state.multiSelectedOptions).length >
                        ...
                        <View>
                          <Text
                            ...
                            On a scale of 1-10, how positive or negative was
                            your experience with this medication?
                            {'\u000A'}
                          </Text>
                          ...
                          <Text
                            ...
                            Would you like to share your experiences with any of
                            the following medications to other users on our app?
                            {'\u000A'}
                          </Text>
                          ...
                          <View
                            ...
                            <Input
                              ...
                              onChangeText={value => {
                                ...
                                this.props.dispatch(
                                  updateEndo101Week6Module6Q4Action(value),
                                );
                              }}
                            />
                          </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            Promise.resolve()
                              ...
                              .then(() => {
                                return this.props.dispatch(
                                  updateEndo101Week6ProgressAction(6),
                                );
                              })
                              .then(() =>
