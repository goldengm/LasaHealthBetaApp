...
import {updateEndo101Week11Module6Q3Action} from '../../../../../../redux/actions/learnActions';
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        Which of the following should you start experiencing a
                        new symptom?
                      </Text>
                    </View>
                    <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week11Module6Q3Action('Ignore it'),
                              );
                            }

                            this.setSelectedIndex(0);
                          }}
                          title={'Ignore it'}></Button>
                      </View>
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week11Module6Q3Action(
                                  'Assume it’s fine',
                                ),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          title={'Talk to your doctor'}></Button>
                      </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week11Module6Q3Action(
                                  'Assume it is related to endometriosis ',
                                ),
                              );
                            }
