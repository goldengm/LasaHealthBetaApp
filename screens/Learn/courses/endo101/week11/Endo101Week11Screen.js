...
class Endo101Week11Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week11.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week11.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn about other conditions that commonly exist with
                    endometriosis.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week11.weekProgress /
                        this.props.endoCourse.week11.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week11Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week11.weekProgress >= 1) {
                          navigation.navigate('Endo101Week11Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week11.weekProgress >= 2) {
                          navigation.navigate('Endo101Week11Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week11.weekProgress >= 3) {
                          navigation.navigate('Endo101Week11Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week11.weekProgress >= 4) {
                          navigation.navigate('Endo101Week11Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week11CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week11.weekProgress <= 0) {
                            navigation.navigate('Endo101Week11Module1Page1');
                          } else if (
                            this.props.endoCourse.week11.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week11Module2Page1');
                          } else if (
                            this.props.endoCourse.week11.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week11Module3Page1');
                          } else if (
                            this.props.endoCourse.week11.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week11Module4Page1');
                          } else if (
                            this.props.endoCourse.week11.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week11Module5Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week11Screen);
