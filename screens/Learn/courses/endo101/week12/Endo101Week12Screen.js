...
class Endo101Week12Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  getModuleProgressIcon = moduleNum => {
    if (this.props.endoCourse.week12.weekProgress > moduleNum) {
      return <Checkmark1 />;
    } else if (this.props.endoCourse.week12.weekProgress == moduleNum) {
      return <InProgress1 />;
    } else {
              ...
              <ScrollView
                ...
                <View
                  ...
                  <Text
                    ...
                    Learn how to thrive with endometriosis including work and
                    relationships.
                  </Text>
                </View>
                ...
                <RoundedTopContainer
                  ...
                  <View
                    ...
                    <LinearProgress
                      ...
                      value={
                        this.props.endoCourse.week12.weekProgress /
                        this.props.endoCourse.week12.numModules
                      }
                      variant="determinate"
                    />
                    <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        navigation.navigate('Endo101Week12Module1Page1');
                      }}>
                      <CheckBox
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week12.weekProgress >= 1) {
                          navigation.navigate('Endo101Week12Module2Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week12.weekProgress >= 2) {
                          navigation.navigate('Endo101Week12Module3Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week12.weekProgress >= 3) {
                          navigation.navigate('Endo101Week12Module4Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week12.weekProgress >= 4) {
                          navigation.navigate('Endo101Week12Module5Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week12.weekProgress >= 5) {
                          navigation.navigate('Endo101Week12Module6Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                        uncheckedColor={theme.COLORS.BACKGROUND3}
                        title="For the partners or loved ones"
                        checked={true}
                        containerStyle={{
                          marginVertical: theme.SIZES.BASE * 0.2,
                          marginTop: 0,
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        if (this.props.endoCourse.week12.weekProgress >= 6) {
                          navigation.navigate('Endo101Week12Module7Page1');
                        }
                      }}>
                      <CheckBox
                        checkedColor={theme.COLORS.PRIMARY2}
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="citations"
                        onPress={() => {
                          navigation.navigate('Endo101Week12CitationsScreen');
                        }}></Button>
                    </View>
                    ...
                    <View
                      ...
                      <Button
                        ...
                        title="Continue"
                        onPress={() => {
                          if (this.props.endoCourse.week12.weekProgress <= 0) {
                            navigation.navigate('Endo101Week12Module1Page1');
                          } else if (
                            this.props.endoCourse.week12.weekProgress == 1
                          ) {
                            navigation.navigate('Endo101Week12Module2Page1');
                          } else if (
                            this.props.endoCourse.week12.weekProgress == 2
                          ) {
                            navigation.navigate('Endo101Week12Module3Page1');
                          } else if (
                            this.props.endoCourse.week12.weekProgress == 3
                          ) {
                            navigation.navigate('Endo101Week12Module4Page1');
                          } else if (
                            this.props.endoCourse.week12.weekProgress == 4
                          ) {
                            navigation.navigate('Endo101Week12Module5Page1');
                          } else if (
                            this.props.endoCourse.week12.weekProgress == 5
                          ) {
                            navigation.navigate('Endo101Week12Module6Page1');
                          } else if (
                            this.props.endoCourse.week12.weekProgress == 6
                          ) {
                            navigation.navigate('Endo101Week12Module7Page1');
                          } else {
...
export default connect(mapStateToProps)(Endo101Week12Screen);
