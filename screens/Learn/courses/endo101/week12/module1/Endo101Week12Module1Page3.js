...
import {updateEndo101Week12Module1Q2Action} from '../../../../../../redux/actions/learnActions';
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module1Q2Action('True'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module1Q2Action('False'),
                              );
                            }
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.selectedIndex >= 0) {
                              navigation.navigate('Endo101Week12Module1Page4');
                            }
                          }}></Button>
                      </View>
                    </View>
