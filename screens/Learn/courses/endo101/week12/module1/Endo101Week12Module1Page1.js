                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text style={{fontSize: theme.SIZES.B1}}>
                        Welcome to the final week of the course! We want to end
                        by reminding you that you deserve to be happy and
                        function normally, despite any challenges that
                        endometriosis may bring. That's why we’re going to talk
                        about ways you can thrive in your day-to-day living
                        while experiencing endometriosis.
                        {'\u000A'}
                        {'\u000A'}
                      ...
                      <View
                        ...
                        <Button
                          ...
                          title="Next"
                          onPress={() => {
                            navigation.navigate('Endo101Week12Module1Page2');
                          }}></Button>
                      </View>
                    </View>
                  </View>
