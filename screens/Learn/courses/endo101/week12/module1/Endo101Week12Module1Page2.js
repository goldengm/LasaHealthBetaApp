...
import {updateEndo101Week12Module1Q1Action} from '../../../../../../redux/actions/learnActions';
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        {'\u000A'}
                        {'\u000A'}
                        Which of the following therapy techniques can be helpful
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module1Q1Action('CBT'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module1Q1Action('ACT'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module1Q1Action('DBT'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module1Q1Action(
                                  'All of the above',
                                ),
                              );
                            }
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.selectedIndex >= 0) {
                              navigation.navigate('Endo101Week12Module1Page3');
                            }
                          }}></Button>
                      </View>
                    </View>
