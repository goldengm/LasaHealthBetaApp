...
import {updateEndo101Week12Module7Q3Action} from '../../../../../../redux/actions/learnActions';
                    ...
                    <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module7Q3Action(
                                  'American Disease Association',
                                ),
                              );
                            }
                          ...
                          title={'American Disease Association'}></Button>
                      </View>
                      ...
                      <View
                        ...
                        <Button
                          ...
                          title={'American with Disabilities Act'}></Button>
                      </View>
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module7Q3Action(
                                  'Accessibility for Diseased Act',
                                ),
                              );
                            }
                            this.setSelectedIndex(2);
                          }}
                          title={'Accessibility for Diseased Act'}></Button>
                      </View>
                      ...
                      {this.state.correctAnswer && (
                        <View
                          ...
                          <Text
                            ...
                            Correct! American with Disabilities Act
                          </Text>
                        </View>
                      )}
