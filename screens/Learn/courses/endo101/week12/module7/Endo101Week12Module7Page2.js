...
import {updateEndo101Week12Module7Q2Action} from '../../../../../../redux/actions/learnActions';
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Text
                        ...
                        True or False? You are required to inform your employer
                        about endometriosis before beginning work.
                      </Text>
                    </View>
                    <View
                      style={{
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module7Q2Action('True'),
                              );
                            }
                      ...
                      <View
                        ...
                        <Button
                          ...
                          onPress={() => {
                            ...
                            if (this.state.selectedIndex <= -1) {
                              this.props.dispatch(
                                updateEndo101Week12Module7Q2Action('False'),
                              );
                            }
                        ...
                        <Button
                          ...
                          onPress={() => {
                            if (this.state.correctAnswer) {
                              navigation.navigate('Endo101Week12Module7Page3');
                            }
                          }}></Button>
                      </View>
                    </View>
