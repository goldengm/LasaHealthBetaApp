...
const contraceptionKeys = {
  usage: {
    ...
    singleOptionList: [
      ...
      {
        title:
          'Extended cycling - 3 weeks and immediately replace. One week break every 9 weeks / 3 patches.',
      },
    ],
    multiOptionList: [],
  ...
  lastPatchStartDate: {
    visibleName: 'Last Patch Start Date',
    inputName: 'lastPatchStartDate',
  ...
  patchReminder: {
    visibleName: 'Patch Reminder',
    inputName: 'patchReminder',
    inputType: 'singleOption',
...
class PatchDetailsSettingsScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps)(PatchDetailsSettingsScreen);
