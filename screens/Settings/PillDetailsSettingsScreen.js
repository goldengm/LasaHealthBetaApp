...
const contraceptionKeys = {
  pillType: {
    visibleName: 'Pill Type',
    inputName: 'pillType',
    inputType: 'singleOption',
    singleOptionList: [
      {title: 'Combined pill'},
      {title: 'Mini-pill (progesterone only)'},
    ],
    multiOptionList: [],
  ...
  lastPackStartDate: {
    visibleName: 'Last Pack Start Date',
    inputName: 'lastPackStartDate',
  ...
  pillReminder: {
    visibleName: 'Pill Reminder',
    inputName: 'pillReminder',
    inputType: 'singleOption',
...
class PillDetailsSettingsScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps)(PillDetailsSettingsScreen);
