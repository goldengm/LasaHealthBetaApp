...
export function menopausePage({ navigation, ...rest }) {
  const condName = "Menopause";
  const condImURL =
    "https://owh-wh-d9-prod.s3.amazonaws.com/s3fs-public/heading-images/Menopausebasics.jpg?VersionId=G93vBlP6qfjshM6tmWC3Mushe0.DM_GK";
...
<div style="text-align: right; padding: 1rem 0px;"><button class="usa-button">Expand All</button></div><div class="qa-wrapper">
  ...
  const condQA = [
    ...
    <div class="answer expanded"><p>Menopause is when your periods stop permanently and you can no longer get pregnant. You have reached menopause only after it has been a full year since your last period. This means you have not had any bleeding, including spotting, for 12 months in a row.</p>
...
<p>Irregular periods happen during this time because you may not ovulate every month. Your periods may be longer or shorter than usual. You might skip a few months or have unusually long or short menstrual cycles. Your period may be heavier or lighter than before. Many women also have hot flashes and other menopause symptoms during this transition.</p>
    ...
    <div class="answer"><p>Sometimes it can be hard for you and your doctor to tell whether you are in perimenopause, the transition to menopause:</p>
