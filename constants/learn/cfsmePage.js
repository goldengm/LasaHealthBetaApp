...
export function cfsmePage({ navigation, ...rest }) {
  const condName = "Chronic Fatigue Syndrome / Myalgic Encephalomyelitis";
  const condImURL =
    "https://owh-wh-d9-prod.s3.amazonaws.com/s3fs-public/heading-images/Chronicfatiguesyndrome.jpg?VersionId=bu8XSjQOYteG3XDgFvqeZdSyiCC.kubH";
