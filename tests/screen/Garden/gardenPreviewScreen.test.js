...
import GardenPreviewScreen from '../../../screens/Garden/GardenPreviewScreen';
...
describe('Testing GardenPreviewScreen', () => {
  it('Testing GardenPreviewScreen instantiation', async () => {
    shallow(
